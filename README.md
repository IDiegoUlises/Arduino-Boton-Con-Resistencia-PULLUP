...
**Advertencia 2:** Esta resistencia solo debe ser utilizarse para una comunicacion de serial o para un boton porque son especializadas para esto en el caso que se utilize para otra cosa puedes quemar el arduino.
